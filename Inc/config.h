...
*/
  ...
  #define PRI_INPUT1            3, 400, 2072, 3700, 150      // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  #define PRI_INPUT2            3, 400, 2072, 3700, 150      // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  #ifdef DUAL_INPUTS
